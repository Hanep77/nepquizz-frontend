...
export default function PasswordInput({ name, label }) {
    ...
    return (
        <div className="mb-3 relative flex">
            ...
            <button type="button" className="px-3 bg-slate-600 hover:bg-slate-500 active:bg-slate-400 border border-slate-500 rounded-e" onClick={() => setShowPassword(!showPassword)}><BsEye /></button>
